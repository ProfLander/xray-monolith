...
template<class T>
IC _vector3<T>& _vector3<T>::hud_to_world()
{
...
template<class T>
IC _vector3<T>& _vector3<T>::world_to_hud()
{
...
template<class T>
IC _vector3<T>& _vector3<T>::hud_to_world_dir()
{
...
template<class T>
IC _vector3<T>& _vector3<T>::world_to_hud_dir()
{
