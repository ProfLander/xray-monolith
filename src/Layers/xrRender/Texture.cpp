...
ID3DBaseTexture* texture_load_dds(
	string_path& fn,
	IReader* S,
	u32& img_size,
	LPSTR fname,
	...
	IDirect3DCubeTexture9* pTextureCUBE,
	u32& dwWidth,
	u32& dwHeight,
	D3DFORMAT& fmt,
	u32& ret_msize,
...
ID3DBaseTexture* texture_load_dds_cube(
	string_path& fn,
	IReader* S,
	u32& img_size,
	LPSTR fname,
...
)
{
	...
	if (FAILED(result))
	{
		...
		xr_strcpy(fn, temp);
		return texture_load_dds(fn, S, img_size, fname, IMG, pTexture2D, pTextureCUBE, dwWidth, dwHeight, fmt, ret_msize, img_loaded_lod, mip_cnt);
	}
...
ID3DBaseTexture* texture_load_dds_2d(
	string_path& fn,
	IReader* S,
	u32& img_size,
	LPSTR fname,
...
)
{
	...
	if (IMG.ResourceType == D3DRTYPE_CUBETEXTURE) return texture_load_dds_cube(fn, S, img_size, fname, IMG, pTexture2D, pTextureCUBE, dwWidth, dwHeight, fmt, ret_msize, img_loaded_lod, mip_cnt);
	return texture_load_dds_2d(fn, S, img_size, fname, IMG, pTexture2D, pTextureCUBE, dwWidth, dwHeight, fmt, ret_msize, img_loaded_lod, mip_cnt);
}

ID3DBaseTexture* texture_load_bump_from_base(
	string_path& fn,
	IReader* S,
	u32& img_size,
	LPSTR fname,
...
ID3DBaseTexture* CRender::texture_load(LPCSTR fRName, u32& ret_msize)
{
	...
	if (strstr(fname, "_bump"))
	{
		if (!FS.exist(fn, "$game_textures$", fname, ".dds"))
			return texture_load_bump_from_base(fn, S, img_size, fname, IMG, pTexture2D, pTextureCUBE, dwWidth, dwHeight, fmt, ret_msize, img_loaded_lod, mip_cnt);
	...
	if (FS.exist(fn, "$level$", fname, ".dds")) return texture_load_dds(fn, S, img_size, fname, IMG, pTexture2D, pTextureCUBE, dwWidth, dwHeight, fmt, ret_msize, img_loaded_lod, mip_cnt);
	if (FS.exist(fn, "$game_saves$", fname, ".dds")) return texture_load_dds(fn, S, img_size, fname, IMG, pTexture2D, pTextureCUBE, dwWidth, dwHeight, fmt, ret_msize, img_loaded_lod, mip_cnt);
	if (FS.exist(fn, "$game_textures$", fname, ".dds")) return texture_load_dds(fn, S, img_size, fname, IMG, pTexture2D, pTextureCUBE, dwWidth, dwHeight, fmt, ret_msize, img_loaded_lod, mip_cnt);
